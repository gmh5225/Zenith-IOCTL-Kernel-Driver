...
#define ZENITH_SUCCESSFUL_OPERATION zenith::status::successful_operation
#define ZENITH_FAILED_SANITY_CHECK zenith::status::failed_sanity_check
#define ZENITH_FAILED_DRIVER_ENTRY zenith::status::failed_entry
